...
def texte(body):
    ...
    tabCaracSub = [r"&agrave", "à",r"&acirc", "â",r"&eacute","é",r"&egrave", "è", r"&ecirc","ê",r"&icirc","î", r"&iuml","ï",r"&oelig" ,"oe",r"&ugrave","ù", r"&ucirc","û", r"&ccedil","ç",r"&nbsp"," ",r"&quot", '"',r"&laquo",'"',r"&raquo",'"',r"&amp","&",r"&euro","€",r"&ocirc", "ô"]


    for i in range(len(tabCaracSub)//2):
    
        chaine = re.sub(tabCaracSub[i*2], tabCaracSub[i*2 + 1], chaine)
